...
public class Fragment1_3 extends Fragment {
    private Button button_detail_3;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = LayoutInflater.from(getActivity()).inflate(R.layout.fragment1_3, container, false);

        super.onCreateView(inflater,container,savedInstanceState);
        //startActivity(new Intent(getActivity(), DetailActivity.class));
        button_detail_3 = (Button)v.findViewById(R.id.button_detail_3);
