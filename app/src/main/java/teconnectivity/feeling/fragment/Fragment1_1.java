...
public class Fragment1_1 extends Fragment {
    private  Button button_detail_1;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = LayoutInflater.from(getActivity()).inflate(R.layout.fragment1_2, container, false);

        super.onCreateView(inflater,container,savedInstanceState);
        //startActivity(new Intent(getActivity(), DetailActivity.class));
        button_detail_1 = (Button)v.findViewById(R.id.button_detail_1);
